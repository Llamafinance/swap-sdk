...
})(exports.Rounding || (exports.Rounding = {})); // export const FACTORY_ADDRESS = '0xBCfCcbde45cE874adCB698cC183deBcF17952812'
...
var Pair = /*#__PURE__*/function () {
  function Pair(factoryAddress, initCodeHash, tokenAmountA, tokenAmountB) {
    this.factoryAddress = factoryAddress;
    this.initCodeHash = initCodeHash;
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(factoryAddress, initCodeHash, tokenAmounts[0].token, tokenAmounts[1].token), 18, 'UNI-V2', 'Uniswap V2');
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    return [outputAmount, new Pair(this.factoryAddress, this.initCodeHash, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    return [inputAmount, new Pair(this.factoryAddress, this.initCodeHash, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(factoryAddress, initCodeHash, tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IPancakePair.abi, provider).getReserves()).then(function (_ref) {
        ...
        return new Pair(factoryAddress, initCodeHash, new TokenAmount(tokenA, balances[0]), new TokenAmount(tokenB, balances[1]));
      });
    } catch (e) {
      return Promise.reject(e);
    }
